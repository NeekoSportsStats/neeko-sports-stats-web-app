  ...
  return (
    <section className="relative mt-10 rounded-3xl border border-yellow-500/40 bg-gradient-to-b from-neutral-950 to-black px-4 py-8">
      <SectionHeader
        ...
        description={`Predictions generated by Neeko AI using ${statConfig.statLabels[stat]} trends and volatility modelling.`}
        icon={BrainCircuit}
      />
