...
const FEATURE_CARDS = [
  {
    icon: LineChart,
    title: "Rankings",
    desc: "Identify the best AFL Fantasy picks each week using projections, matchup difficulty and value modelling.",
  ...
  },
  {
    icon: Sparkles,
    title: "Edge Board",
    desc: "Discover captain edges, breakout candidates and trap warnings generated by the Neeko projection engine.",
  ...
  },
  {
    icon: TrendingUp,
    title: "Market Watch",
    desc: "Spot underpriced players and avoid overvalued traps before price changes.",
    ...
    <section className="py-10 md:py-14 bg-[#070707] border-t border-white/[0.05]">
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {FEATURE_CARDS.map(({ icon: Icon, title, desc, link, cta, premium }) => (
            <Link
              key={title}
              to={link}
        ...
        <div className="mt-8 flex justify-center">
          <Link
            to="/neeko-plus"
            className="inline-flex items-center justify-center gap-2 bg-[#F5C84C] text-black font-bold text-sm px-7 py-3 rounded-xl hover:brightness-110 transition-all min-h-[44px]"
          >
            <Crown size={13} />
            Unlock All Tools With Neeko+
          </Link>
        </div>
      </div>
    </section>
      ...
      <section className="relative overflow-hidden min-h-[72vh] flex items-center">
        ...
        <div className="relative z-10 w-full max-w-4xl mx-auto px-5 py-16 md:py-24 text-center">
          ...
          <p className="text-base md:text-xl text-neutral-400 font-medium mb-10 max-w-2xl mx-auto leading-relaxed px-1">
            Neeko combines projections, matchup difficulty, value modelling and AI insights to help serious AFL Fantasy coaches pick better captains, avoid traps and spot breakouts before every round lockout.
          </p>
      ...
      <section className="py-12 md:py-16 bg-[#0a0a0a] border-t border-white/[0.05]">
        <div className="max-w-xl mx-auto px-5 text-center">
          ...
          <p className="text-white/40 text-sm mb-5 max-w-sm mx-auto leading-relaxed">
            Updated projections and insights before every AFL Fantasy lockout.
          </p>
